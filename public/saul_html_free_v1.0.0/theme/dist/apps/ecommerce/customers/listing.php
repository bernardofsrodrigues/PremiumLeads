...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../"/>
		<title>Controle de Basess</title>
		<meta charset="utf-8" />
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td>
															<a href="#" class="text-gray-800 text-hover-primary mb-1">Base exemplo</a>
														</td>
														<td>
														...
														<td>
															<!--begin::Badges-->
															<div class="badge badge-light-danger">Erro</div>
															<!--end::Badges-->
														</td>
														<td>Willian.foco</td>
														<td>21 Fev 2024, 5:20 pm</td>
														<td class="text-end">
