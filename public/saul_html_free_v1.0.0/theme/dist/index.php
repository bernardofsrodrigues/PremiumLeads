				...
				<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
					...
					<div class="d-flex align-items-center flex-stack flex-grow-1">
						<div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
							...
							<!--begin::Logo-->
							<a href="../dist/index.php" class="app-sidebar-logo" style="display: flex; align-items: center;">
								<img alt="Logo" src="assets/media/logos/logo-pl.png" class="h-30px theme-light-show" />
								<img alt="Logo" src="assets/media/logos/logo-pl.png" class="h-30px theme-dark-show"/>
							...
							<div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1 me-2 me-lg-0">
								...
								<div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
									...
									<form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
										...
										<!--end::Icon-->
										<!--begin::Input-->
										<input type="text" class="search-input form-control form-control border-0 h-lg-40px ps-13" name="search" value="" placeholder="Pesquisar..." data-kt-search-element="input" />
										<!--end::Input-->
										<!--begin::Spinner-->
										...
										<div class="tab-pane fade" id="kt_topbar_notifications_3" role="tabpanel">
											...
											<div class="scroll-y mh-325px my-5 px-8">
												...
												<div class="d-flex flex-stack py-4">
													...
													<div class="d-flex align-items-center me-2">
														<!--begin::Code-->
														<span class="w-70px badge badge-light-danger me-4">ERRO 500</span>
														<!--end::Code-->
														<!--begin::Title-->
												...
												<div class="d-flex flex-stack py-4">
													...
													<div class="d-flex align-items-center me-2">
														<!--begin::Code-->
														<span class="w-70px badge badge-light-warning me-4">ATENÇÃO 300</span>
														<!--end::Code-->
														<!--begin::Title-->
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">{name user}</div>
												<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{email user}</a>
											</div>
											<!--end::Username-->
										</div>
									</div>
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
												...
												<li class="breadcrumb-item text-gray-700 fw-bold lh-1">
													<a href="../dist/index.php" class="text-gray-500">
